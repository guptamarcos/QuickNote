      ...
      {user && (
        <nav className="flex justify-between items-center">
          ...
          <div className="flex gap-[0.5rem] items-center">
            ...
            <form onSubmit={handleSubmit} className=" p-[0.4rem] flex flex-col justify-center align-center ">
              <p className="text-center"><b>{user.username}</b></p>
              <button to="/quicknote/home">
                Logout
              </button>
            </form>
          </div>
